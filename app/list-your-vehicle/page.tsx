...
export default function ListYourVehiclePage() {
  ...
  if (!entryMode) {
    return (
      <main className={`min-h-screen ${page}`} data-loadlink-vehicle-portal="source-v8">
        ...
        <section className="relative flex min-h-[600px] w-full items-end overflow-hidden bg-black text-white md:min-h-[620px]">
          ...
          <div className="relative z-10 mx-auto w-full max-w-6xl px-5 pb-10 pt-20 text-center">
            <p className="text-[10px] font-black uppercase tracking-[.16em] text-[#f6b800]">Commercial marketplace</p>
            <h1 className="mx-auto mt-3 max-w-4xl text-[clamp(3rem,12vw,5.7rem)] font-black leading-[.94] tracking-[-.055em]">
  ...
  return (
    <main className={page} data-loadlink-vehicle-listing-shell="source-step-flow-v8">
      <LoadLinkSiteHeader darkMode={darkMode} onToggleTheme={toggleTheme} />
      ...
      <style jsx global>{`
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #listing-form > main > header,
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #listing-form > main > section:first-of-type,
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #listing-form #plans {
          display: none !important;
        }
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #vehicle-listing-form {
          padding-bottom: max(118px, calc(env(safe-area-inset-bottom) + 94px)) !important;
        }
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #vehicle-listing-form > section[hidden] {
          display: none !important;
        }
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] #vehicle-listing-form > section[data-loadlink-wizard-active="true"] {
          scroll-margin-top: 178px;
        }
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] input,
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] select,
        [data-loadlink-vehicle-listing-shell="source-step-flow-v8"] textarea {
