...
const platformTools = [
  {
    ...
    copy: "Identity, business and profile checks designed to make marketplace interactions more accountable.",
  },
  {
    title: "Direct messaging",
    copy: "Move from discovery to conversation without leaving the LoadLink platform.",
  },
  {
    title: "Dealership tools",
    copy: "Purpose-built listing, customer and inventory tools for commercial vehicle dealerships.",
  },
  {
    title: "Smart listing management",
    copy: "Manage posts, availability and responses from one simple workspace.",
  },
  {
    title: "Logistics tools",
    copy: "Practical tools designed around everyday transport and logistics workflows.",
  },
  {
    title: "Pro insights",
    copy: "Enhanced visibility and performance insights for businesses that need more from the marketplace.",
  },
];
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
        ...
        <div className="mx-auto flex h-[78px] w-full max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-12">
          <a href="#top" aria-label="LoadLink home" className="block">
            <img
              ...
              width={1200}
              height={391}
              className="h-auto w-[142px] object-contain sm:w-[160px]"
            />
          </a>
          ...
          <a
            href="#trial"
            className="inline-flex min-h-10 items-center justify-center rounded-full border border-white/12 bg-white/[0.04] px-4 text-xs font-black text-white transition hover:border-white/25 hover:bg-white/[0.08]"
          >
            Coming soon
          </a>
        </div>
      ...
      <div id="top" className="relative isolate">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 -z-20 h-[900px]"
          style={{
            background:
              "radial-gradient(circle at 50% 2%, rgba(246,184,0,.18), transparent 31%), radial-gradient(circle at 85% 34%, rgba(246,184,0,.07), transparent 22%)",
          }}
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[760px] opacity-[0.13]"
          style={{
            backgroundImage:
        ...
        <section className="mx-auto grid min-h-[calc(100svh-78px)] w-full max-w-[1440px] items-center gap-14 px-5 py-14 sm:px-8 md:py-20 lg:grid-cols-[1.05fr_.95fr] lg:px-12 lg:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-7 max-w-4xl text-[clamp(3.8rem,8vw,7.9rem)] font-black leading-[0.86] tracking-[-0.075em]">
              Logistics,
              <br />
              made easier.
            </h1>
            ...
            <p className="mt-7 max-w-2xl text-base font-semibold leading-8 text-white/58 sm:text-lg md:text-xl md:leading-9">
              A focused South African marketplace for logistics opportunities,
              commercial vehicles, mobile units, drivers and the businesses that
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <a
                href="#features"
                className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-[#f6b800] px-6 text-sm font-black text-black transition hover:-translate-y-0.5 hover:bg-[#ffc31a]"
              >
                Explore what&apos;s coming
                <span className="transition-transform group-hover:translate-x-0.5"><ArrowIcon /></span>
              </a>
              <span className="text-xs font-bold text-white/34">Built for South African logistics</span>
            </div>
          </div>
            ...
            <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[#0c0c0c] shadow-[0_35px_100px_rgba(0,0,0,.45)]">
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  {["Jobs", "Contracts", "Drivers"].map((label) => (
                    <div key={label} className="rounded-2xl border border-white/[0.08] bg-white/[0.035] px-3 py-4 text-center text-xs font-black text-white/72">
                      {label}
                    </div>
                  ))}
                </div>
      ...
      <section id="features" className="border-t border-white/[0.08] bg-[#080808] px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        <div className="mx-auto w-full max-w-[1440px]">
          <div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-end">
            ...
            <p className="max-w-2xl text-base font-semibold leading-8 text-white/52 lg:ml-auto lg:text-lg">
              LoadLink brings the most important logistics workflows into a single, focused experience — without turning the platform into a cluttered general marketplace.
            </p>
          </div>
            ...
            {features.map((feature) => (
              <article key={feature.title} className="group relative min-h-[430px] overflow-hidden rounded-[30px] border border-white/[0.08] bg-[#111]">
                ...
                <div className="relative flex min-h-[430px] flex-col justify-between p-6 sm:p-8">
                  ...
                  <div>
                    <h3 className="text-4xl font-black tracking-[-0.05em] sm:text-5xl">{feature.title}</h3>
                    <p className="mt-3 max-w-lg text-sm font-semibold leading-7 text-white/68 sm:text-base">{feature.copy}</p>
                  </div>
                </div>
              </article>
            ))}
        ...
        <div className="mx-auto w-full max-w-[1440px]">
          ...
          <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {platformTools.map((tool) => (
              <article key={tool.title} className="min-h-[220px] rounded-[26px] border border-white/[0.08] bg-white/[0.025] p-6 sm:p-7">
                <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#f6b800]/25 bg-[#f6b800]/[0.08] text-[#f6b800]">
                  <CheckIcon />
                </div>
                <h3 className="mt-8 text-2xl font-black tracking-[-0.035em]">{tool.title}</h3>
                <p className="mt-3 text-sm font-semibold leading-7 text-white/48">{tool.copy}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section id="safety" className="px-5 pb-24 sm:px-8 md:pb-32 lg:px-12">
        <div className="mx-auto grid w-full max-w-[1440px] overflow-hidden rounded-[34px] border border-white/[0.08] bg-[#0b0b0b] lg:grid-cols-2">
          <div className="p-7 sm:p-10 md:p-14 lg:p-16">
            ...
            <p className="mt-6 max-w-xl text-base font-semibold leading-8 text-white/52">
              LoadLink is being built with verification, moderation, reporting and clear marketplace controls so users can make more informed decisions before they deal.
            </p>

            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {["Profile verification", "Listing moderation", "Reporting tools", "Account controls"].map((item) => (
                <div key={item} className="flex items-center gap-3 border-t border-white/[0.08] pt-4 text-sm font-black text-white/75">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#f6b800] text-black"><CheckIcon /></span>
                  {item}
                </div>
              ))}
            </div>
            ...
            <div className="relative flex h-full min-h-[430px] items-center justify-center p-7 sm:p-10">
              <div className="w-full max-w-md rounded-[30px] border border-white/10 bg-black/55 p-5 shadow-[0_30px_80px_rgba(0,0,0,.4)] backdrop-blur-xl">
                <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
                  <div>
                    <p className="text-xs font-black text-white/42">Marketplace status</p>
                    <p className="mt-1 text-lg font-black">Designed for safer dealing</p>
                  </div>
                  <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f6b800] text-black"><CheckIcon /></span>
                </div>
                <div className="grid gap-3 pt-4">
                  {["Know who you are dealing with", "Keep communication connected", "Report suspicious activity", "Review listing information before dealing"].map((item) => (
                    <div key={item} className="flex items-center gap-3 rounded-2xl bg-white/[0.035] px-4 py-3 text-sm font-bold text-white/64">
      ...
      <section className="border-y border-white/[0.08] bg-[#080808] px-5 py-20 sm:px-8 md:py-24 lg:px-12">
        <div className="mx-auto grid w-full max-w-[1440px] gap-10 md:grid-cols-3">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.14em] text-white/32">For operators</p>
            <h3 className="mt-3 text-2xl font-black tracking-[-0.035em]">Find work. List equipment. Stay connected.</h3>
          </div>
          <div>
            <p className="text-xs font-black uppercase tracking-[0.14em] text-white/32">For businesses</p>
            <h3 className="mt-3 text-2xl font-black tracking-[-0.035em]">Find transport capacity without the marketplace noise.</h3>
          </div>
          <div>
            <p className="text-xs font-black uppercase tracking-[0.14em] text-white/32">For dealerships</p>
            <h3 className="mt-3 text-2xl font-black tracking-[-0.035em]">A commercial sales workspace built around vehicles.</h3>
          </div>
        </div>
      </section>
      ...
      <section id="trial" className="relative isolate px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <img
            ...
            width={1200}
            height={391}
            className="mx-auto h-auto w-[180px] object-contain sm:w-[210px]"
          />
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base font-semibold leading-8 text-white/52 md:text-lg">
            Apply for a free trial and tell us how you plan to use LoadLink. Your email app will open with the application already addressed to the LoadLink team.
          </p>

          <a
            href={FREE_TRIAL_EMAIL}
            className="group mx-auto mt-9 inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-[#f6b800] px-8 text-sm font-black text-black shadow-[0_16px_50px_rgba(246,184,0,.14)] transition hover:-translate-y-0.5 hover:bg-[#ffc31a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f6b800] focus-visible:ring-offset-4 focus-visible:ring-offset-[#050505]"
