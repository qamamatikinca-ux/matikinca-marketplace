...
export default function ContractsPage() {
  ...
  return (
    <main className={`min-h-screen scroll-smooth ${darkMode ? "bg-black text-white" : "bg-[#fff7df] text-black"}`} data-loadlink-contracts-marketplace="contract-search-20260823">
      ...
      <section className="relative min-h-[78vh] overflow-hidden border-b border-[#f6b800]/40">
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-5xl flex-col justify-end px-5 pb-8 pt-20">
          ...
          <div data-loadlink-contracts-search-shell className={`loadlink-glass mt-6 rounded-[24px] border p-4 shadow-[0_20px_60px_rgba(0,0,0,.18)] backdrop-blur-xl md:p-5 ${darkMode ? "border-[#f6b800]/55 bg-black/72" : "border-white/55 bg-white/68"}`}>
            <div className="grid gap-3 md:grid-cols-2">
              <label className="block">
                <span className="mb-2 block text-[10px] font-black uppercase tracking-[.15em] text-[#f6b800]">Contract / scope</span>
              ...
              <label className="block">
                <span className="mb-2 block text-[10px] font-black uppercase tracking-[.15em] text-[#f6b800]">Category</span>
              ...
              <label className="block">
                <span className="mb-2 block text-[10px] font-black uppercase tracking-[.15em] text-[#f6b800]">Vehicle / mobile unit needed</span>
              ...
              <label className="relative block">
                <span className="mb-2 block text-[10px] font-black uppercase tracking-[.15em] text-[#f6b800]">Operating location</span>
                  ...
                  <div className="grid md:grid-cols-[220px_minmax(0,1fr)]">
                    ...
                    <div className="p-5 md:p-6">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        ...
                        <span className={`rounded-full border px-3 py-1 text-[10px] font-black ${darkMode ? "border-[#f6b800]/35 text-[#f6b800]" : "border-[#f6b800]/45 text-[#8c6800]"}`}>{startLabel(row)}</span>
                      </div>
