...
export default function AuthLandingShell({
  ...
  return (
    <main
      data-loadlink-auth-landing="v283"
      ...
      <div className="mx-auto min-h-[100svh] w-full max-w-[760px] lg:flex lg:max-w-none">
        <section className="relative h-[36svh] min-h-[250px] overflow-hidden bg-[#16110a] sm:h-[42svh] lg:h-screen lg:min-h-screen lg:flex-1">
          <img
            ...
            aria-hidden="true"
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,.10),rgba(0,0,0,.22)_55%,rgba(0,0,0,.52))]" aria-hidden="true" />
