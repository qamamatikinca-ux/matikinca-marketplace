  ...
  return (
    ...
    >
      <div className="mx-auto min-h-[100svh] w-full max-w-[760px] lg:flex lg:max-w-none">
        ...
        <section
          className={`loadlink-glass loadlink-auth-panel relative z-20 -mt-6 rounded-t-[30px] border px-5 pb-[max(1.35rem,env(safe-area-inset-bottom))] pt-6 sm:px-8 sm:pt-8 lg:mt-0 lg:flex lg:w-[min(45vw,560px)] lg:flex-col lg:justify-center lg:rounded-none lg:border-l lg:border-t-0 lg:px-11 ${
