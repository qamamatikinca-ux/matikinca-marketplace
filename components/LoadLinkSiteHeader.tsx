...
export default function LoadLinkSiteHeader({
  ...
  return (
    ...
    >
      <div className="relative mx-auto flex h-full w-full max-w-[1500px] items-center px-4 sm:px-5">
        ...
        <LoadLinkThemeToggle darkMode={darkMode} onToggle={onToggleTheme} className="relative z-10 ml-auto" />
      </div>
    </header>
  );
}
