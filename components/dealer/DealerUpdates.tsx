...
import type { DealerInventoryItem, DealerUpdate, DealerWorkspaceState } from "@/lib/dealer/types";
import { EmptyState, Input, Modal, PrimaryButton, SectionHeading, Select, SecondaryButton, Surface, Textarea } from "./ui";

const TYPES: Array<{ value: DealerUpdate["update_type"]; label: string }> = [
  { value: "new_arrival", label: "New arrival" }, { value: "new_stock", label: "New stock" },
  { value: "price_reduction", label: "Price reduction" }, { value: "weekend_special", label: "Weekend special" },
  { value: "finance_offer", label: "Finance offer" }, { value: "clearance", label: "Clearance" },
  { value: "branch_announcement", label: "Branch announcement" }, { value: "trading_hours", label: "Trading hours" },
];
