  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-4 py-8 md:px-6 md:py-12">
      <div className={`border p-5 md:p-7 ${surface}`}>
        ...
        {!schemaReady ? (
          <div className="mt-6 border border-red-500/40 bg-red-500/10 p-4 text-sm font-bold leading-6">The package database migration has not been installed yet. Run <strong>supabase/migrations/20260801_000001_loadlink_professional_marketplace.sql</strong> in Supabase before accepting paid listings.</div>
        ) : null}
