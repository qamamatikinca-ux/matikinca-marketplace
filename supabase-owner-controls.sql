...
create or replace function public.increment_job_view(
  p_job_id uuid,
  p_viewer_key text
)
returns boolean
...
begin
  ...
  set
    ...
    last_viewed_at = now()
  where id = p_job_id
    and (owner_key is null or owner_key = '' or owner_key <> p_viewer_key);
